...
ExpCatViz(data,target=NULL,fname=NULL,clim=10,margin=2,Page = c(2,1),sample=sc)
```
...
ExpCatViz(data,target=Target,fname=NULL,clim=10,margin=2,Page = c(2,1),sample=sc)
```
