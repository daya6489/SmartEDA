...
ExpCTable(data,Target=NULL,margin=1,clim=10,nlim=NULL,round=2,bin=NULL,per=T)
```
...
ExpCatViz(data,target=NULL,fname=NULL,clim=10,margin=2,Page = c(2,2),sample=sc)
```
